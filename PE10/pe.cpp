/* Project Euler Nº9
	...
	@ Descripción: Calcula el número primo que esté en la 
	  posición número 10.001.
...
int main(){
	...
	int numero_a_comprobar = 3; // Empezamos en el número tres.
	unsigned long long numero_resultado = 2;   // Compensamos añadiendo el 2. El 1 no lo cuenta como primo.
	...
	*/
	cout << "El número primo es: " << numero_resultado << endl;
}
